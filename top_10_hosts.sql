...
The query retrieves the id, the lesting url,calculates how many days in the next 30 days are booked,the price and the projected revenue in the next 30 days.
